...
data_raw <- read_csv("C:/Users/Admin/Desktop/New folder/jamesbond.csv")
...
world %>%
  ...
  labs(title = "James Bond Movies",
       subtitle = "All countries visitedby James Bond in all the movies saga",
       x = NULL, y = NULL,
       caption = "GIDEON SIMIYU MAP")
...
world %>%
  ...
  theme(plot.title = element_text(face = "bold"),
        axis.text.x = element_blank(),
        legend.position = "none") +
  labs(title = "James Bond Casino Royale",
       subtitle = "Countries visited in Casino Royale",
       x = NULL, y = NULL,
       caption = "GIDEON SIMIYU MAPS")
...
world %>%
  ...
  theme(plot.title = element_text(face = "bold"),
        axis.text.x = element_blank(),
        legend.position = "none") +
  labs(title = "James Bond = DANIEL GRAIG",
       subtitle = "Countries visited By ACTOR Daniel Craig's in James Bond movies",
       x = NULL, y = NULL,
       caption = "GIDEON SIMIYU MAPS")
...
world %>%
  ...
  theme(plot.title = element_text(face = "bold"),
        axis.text.x = element_blank(),
        legend.position = "none") +
  labs(title = "All the James Bond Movies",
       subtitle = "Countries visited in movies, by each actor",
       x = NULL, y = NULL,
       caption = "GIDEON SIMIYU MAPS")
...
world %>%
  ...
  labs(title = "Countries by region",
       #subtitle = "All countries visited in the movies saga",
       x = NULL, y = NULL,
       caption = "GIDEON SIMIYU MAPS")
